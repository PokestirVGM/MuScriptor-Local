...
The experimental Windows AMD engine downloads Microsoft's torch-directml package and its matching PyTorch/torchvision dependencies during setup. DirectML and those packages retain their own licenses; installed metadata and notices remain in the private engine environment. Source and package information: https://github.com/microsoft/DirectML and https://pypi.org/project/torch-directml/.
