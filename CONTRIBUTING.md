...
Use a dedicated Python environment. macOS builds require Apple Silicon, macOS 14+, and Xcode Command Line Tools. The Windows preview has its own build workflow and hardware-validation requirements on the development branch. Record what was actually tested; do not describe mocked GPU checks as real hardware validation.
